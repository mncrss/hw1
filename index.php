  ...
  <body>
    ...
    <header id = "background">
      <div id = "frecce">
        ...
        <h1>Pescheria gastronomica<br>Catania</h1>
    ...
    <section id="sconto">
      ...
      <p id= 'accesso' class='hidden'>Per ottenere un codice sconto devi effettuare l'accesso!</p>      
    ...
    <section id="paragrafo5">   
      ...
      <form name="rece" method="POST" action="submit_review.php" id="reviewForm">
        <label>Lascia la tua recensione!</label>
        <textarea id="addComment" name="comment" placeholder='Scrivi qui..'></textarea>
